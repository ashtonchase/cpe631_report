...
The goals of our project are to investigate the source material provided by UC Burkeley's Rocket Chip Generator. Specifically, we will recreate some of their results using their provided source code and documentation hosted at (https://github.com/ucb-bar/fpga-zynq). Our goals are listed in order or complexity. The intent was that as each goal is achieved, efforts will be focus on the next item; however, not all goals very fully achievable.
